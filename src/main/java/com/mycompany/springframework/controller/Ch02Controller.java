...
public class Ch02Controller {
	...
	public String getMethodAjax(String bkind, String bno, Model model) {
	   ...
	   public ModelAndView modelAndViewReturn(String chNum, Model model) {
		   log.info("modelAndViewReturn() 실행");
		   ModelAndView modelAndView = new ModelAndView();
		   modelAndView.addObject("chNum", chNum);
		   modelAndView.addObject("Login 여부", true);
		   modelAndView.addObject("User Name", "감자바");
	   ...
	   public void imageDownload(HttpServletRequest request, HttpServletResponse response) throws IOException{
		   ...
		   //실제 파일의 경로 얻기
		   String urlPath = "resources/images/photos/photo1.jpg";
	   ...
	   @GetMapping(value="/objectTypeJson2",
			   		produces = "application/json; charset=UTF-8")
	   @ResponseBody //리턴된 객체를 JSON으로 해석하고 응답 본문에 넣겠다.
	   public Ch02FileInfo objectReturnJson2() {
		   log.info("objectTypeJson2() 실행");
